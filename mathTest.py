...
def mathTest():
    ...
    # 向大取整：math.ceil()
    print(f"ceil(-0.5) 向大取整: {math.ceil(-0.5)}")
    print(f"ceil(0.5) 向大取整: {math.ceil(0.5)}")

    # 向小取整：math.floor() 以及 //

    print(f"floor(-0.3) 向小取整: {math.floor(-0.3)}")
    print(f"floor(0.5) 向小取整: {math.floor(0.5)}")

    print(f"-3 // 10 向小取整: {math.floor(-3 // 10)}")
    print(f"5 // 10 向小取整: {math.floor(5 // 10)}")


    # 向0取整 : int()

    print(f"int(-0.3) 向0取整: {int(-0.3)}")
    print(f"int(0.3) 向0取整: {int(0.3)}")
